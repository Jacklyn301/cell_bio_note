...
<div style="display: flex; gap: 20px">
    <img src="https://raw.githubusercontent.com/Jacklyn301/image_bank/main/peptidoglycan_structure_0425.png" style="width: 80%; margin-right: 10%; margin-left: 10%;">
</div>
...
<div style="display: flex; gap: 20px">
    <img src="https://alchetron.com/cdn/cellulose-2564aebd-51cd-4618-abf0-9f0e0281f1f-resize-750.jpeg" style="width: 80%; margin-right: 10%; margin-left: 10%;">
</div>
...
<div style="display: flex; gap: 20px">
    <img src="https://golifescience.com/wp-content/uploads/2012/08/plant-cell-wall-layers.png" style="width: 70%; margin-right: 15%; margin-left: 15%;">
</div>
...
<div style="display: flex; gap: 20px">
    <img src="https://raw.githubusercontent.com/Jacklyn301/image_bank/main/the_synthesis_of_cellulose_0425.png" style="width: 70%; margin-right: 15%; margin-left: 15%;">
</div>
...
![image alt](https://microbenotes.com/wp-content/uploads/2023/12/Osmosis-and-Turgor-Pressure-in-Plant-Cells-1024x581.jpg)
...
<div style="display: flex; gap: 20px">
    <img src="https://media.geeksforgeeks.org/wp-content/uploads/20240404111132/Diagram-of-Connective-Tissue.webp" style="width: 80%; margin-right: 10%; margin-left: 10%;">
</div>
...
<div style="display: flex; gap: 20px">
    <img src="https://www.frontiersin.org/files/Articles/516467/fimmu-11-00483-HTML/image_m/fimmu-11-00483-g001.jpg" style="width: 80%; margin-right: 10%; margin-left: 10%;">
</div>
...
flowchart LR
RER{rough ER}:::rer
RER-->|形成三個<br>alpha helix|ppc([preprocollagen]):::precursor
ppc-->complete(排列完成):::process
complete-->golgi(在golgi羥基或是糖基化修飾):::golgi
golgi-->|產生|pc([procollagen]):::precursor
pc-->cut(切割兩端，形成帶狀構造):::process
cut-->ec(非網格蛋白介導胞吐作用):::exocytosis
ec-->|成為|tpc([tropocollagen]):::final


classDef rer fill:#ffadad,stroke:#c0392b,stroke-width:2.5px,color:#000
classDef precursor fill:#fff0b5,stroke:#daa520,stroke-width:2px,color:#000
classDef process fill:#d6eaff,stroke:#3498db,stroke-width:2px,color:#000
classDef golgi fill:#a8d8ff,stroke:#2980b9,stroke-width:2px,color:#000
...
<div style="display: flex; gap: 20px">
    <img src="https://image1.slideserve.com/3593560/fibronectin1-l.jpg" style="width: 70%; margin-right: 15%; margin-left: 15%;">
</div>
...
![image alt](https://www.mdpi.com/ijms/ijms-16-18149/article_deploy/html/images/ijms-16-18149-g001.png)
...
```mermaid
  timeline
  title 白血球-內皮細胞交互作用 🐱
  Rolling : 內皮細胞表面表達<br>選擇素，例如<br>E-selectin跟<br>P-selectin : 白血球上的糖蛋白<br>，如PSGL-1，與<br>選擇素結合，形成<br>弱而可斷裂的連結 : 白血球因在血管壁上<br>慢慢滾動
  Activation : 內皮細胞分泌<br>趨化因子，chemokines<br>，例如 IL-8 : 白血球上的受體<br>接收到訊號，觸發<br>integrins從低親和力<br>狀態轉換成高親和力
  Adhesion : 白血球的整合素，<br>如LFA-1,、VLA-4，<br>與內皮細胞上的ICAM-1、<br>VCAM-1結合 : 這種強而穩定的連結<br>會讓白血球停下來
  Transmigration : 白血球利用PECAM-1<br>等分子，穿過內皮細胞<br>間隙或直接穿透細胞 : 最後進入組織，<br>執行免疫功能
```

![image alt](https://raw.githubusercontent.com/Jacklyn301/image_bank/main/leukocyte-endothelial_cell_interaction_0425.png)
...
<div style="display: flex; gap: 20px">
    <img src="https://www.frontiersin.org/files/Articles/998373/fcell-10-998373-HTML-r2/image_m/fcell-10-998373-g001.jpg" style="width: 70%; margin-right: 15%; margin-left: 15%;">
</div>
...
<div style="display: flex; gap: 20px">
    <img src="https://project.inria.fr/keops/files/2012/07/keopsgap1.png" style="width: 70%; margin-right: 15%; margin-left: 15%;">
</div>
...
<div style="display: flex; gap: 20px">
    <img src="https://raw.githubusercontent.com/Jacklyn301/image_bank/main/plasmodesmata_structure_0425.png" style="width: 70%; margin-right: 15%; margin-left: 15%;">
</div>